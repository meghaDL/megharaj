...
def set_background(image_file):
    ...
    st.markdown(
        ...
        .stApp {{
           ...
           <p background-size:contain;width=500px:hieght=500px;</p>
            ...
            align-items: center;
            padding-left: 50px;
            width="500"hieght="500;"/* Adjust the padding as needed */
        }}
        </style>
        """,
...
with open('C:\Users\hp\lg_model.pkl', 'rb') as model_file,     open('C:\Users\hp\tfidf_vectorizer.pkl','rb') as vectorizer_file:
